<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectCreateEditEmbed.aspx.cs" Inherits="ProjectCollection.WebUI.pages.ProjectCreateEditEmbed" %>

<%@ PreviousPageType VirtualPath="~/pages/ProjectList.aspx" %>
...
<body>
    ...
    <asp:Panel ID="PanelBaseBtn" runat="server">
        <asp:Button ID="btnCancel" runat="server" Text="取消" OnClick="btnCancel_Click" OnClientClick="window.parent.popupEdit.Hide();"/>
        <asp:Button ID="btnOk" runat="server" Text="派发工单" OnClick="btnOk_Click" OnClientClick="window.parent.popupEdit.Hide();" Visible="false" />
